...
val of_typed : filename:string -> Ocaml_parsing.Location.t -> Merlin.Location.t
(** [of_typed ~filename loc] converts a compiler location to a Merlin location.
*)
...
(** [current_dir_relative path] returns [path] relative to the current directory
    when possible. *)
