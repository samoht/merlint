...
let style_pass = Console.Style.(fg Console.Color.green)
let style_fail = Console.Style.(fg Console.Color.red)

let pp_color passed =
  Console.Style.styled (if passed then style_pass else style_fail) Fmt.string
