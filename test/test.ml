...
let () =
  let suites =
    Test_config.suite @ Test_browse.suite @ Test_outline.suite
    @ Test_typedtree.suite @ Test_parsetree.suite @ Test_complexity.suite
    @ Test_doc.suite @ Test_dune.suite @ Test_format.suite @ Test_issue.suite
    ...
    @ [ Test_api_design.suite; Test_rule_filter.suite ]
  in
