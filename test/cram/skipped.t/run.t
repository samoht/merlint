...
the status never disagree:
  ...
  {"project_root":"$TESTCASE_ROOT/t","files_analyzed":0,"rules_applied":0,"total_issues":0,"unchecked":0,"unchecked_files":[],"unclaimed_files":[],"skipped_paths":["t/notes.txt"],"failed_checks":[],"build_failure":null,"passed":false,"issues":[],"excluded":[]}
  [2]
