...
Test no-Wire edge case - a non-Wire package may expose an unrelated struct_ value:
...
Test provider edge case - the wire package itself may expose its EverParse
projection helpers:
  $ (cd self && dune build @check)

  $ merlint --build -r E905 self/
