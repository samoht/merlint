...
A function nested in a functor body is reported at its own location:
  $ merlint --build -r E010 functor_body.ml
  ...
  ✗ Code Quality (1 total issues)
    ...
    - functor_body.ml:9:2: Function 'process' has nesting depth of 5 (threshold: 4)
