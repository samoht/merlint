...
Build bad fixture project:
  ...
  {"project_root":"$TESTCASE_ROOT/bad/","files_analyzed":4,"rules_applied":1,"total_issues":1,"unchecked":0,"unchecked_files":[],"unclaimed_files":[],"skipped_paths":[],"passed":false,"issues":[{"code":"E956","title":"Dead library dependency","category":"Project Structure","message":"spy is linked by stanza consumer but never imported: no compilation unit of spy appears in the stanza's .cmt imports. Remove it from (libraries ...).","location":{"file":"bad/consumer/dune","start":{"line":1,"column":0},"end":{"line":1,"column":0}}}],"excluded":[]}
  [1]
