...
Test JSON report - should encode the scan report, not only logs:
  ...
  {"project_root":"$TESTCASE_ROOT/","files_analyzed":1,"rules_applied":1,"total_issues":1,"unchecked":0,"passed":false,"issues":[{"code":"E105","title":"Catch-all Exception Handler","category":"Code Quality","message":"Catch-all exception handler found. This can hide unexpected errors.","location":{"file":"bad.ml","start":{"line":1,"column":29},"end":{"line":1,"column":30}}}],"excluded":[]}
  [1]
