...
output parses:
  ...
  {"project_root":"$TESTCASE_ROOT/","files_analyzed":1,"rules_applied":1,"total_issues":0,"unchecked":0,"unchecked_files":[],"unclaimed_files":[],"skipped_paths":[],"failed_checks":[],"build_failure":null,"passed":true,"issues":[],"excluded":[]}
