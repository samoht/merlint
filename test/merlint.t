Test simple functions with low complexity
  $ merlint --simple samples/simple.ml
...
Test function with high cyclomatic complexity
  $ merlint --simple samples/complex.ml
...
Test long function detection
  $ merlint --simple samples/long_function.ml
...
Test naming conventions
  $ merlint --simple samples/bad_names.ml
...
Test style rules - Str module
  $ merlint --simple samples/uses_str.ml
...
Test catch-all exception handler
  $ merlint --simple samples/catch_all.ml
